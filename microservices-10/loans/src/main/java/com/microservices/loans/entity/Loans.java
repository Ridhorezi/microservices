...
public class Loans extends BaseEntity {
	...
	public String toString() {
		return "Loans [loanId=" + loanId + ", mobileNumber=" + mobileNumber + ", loanNumber=" + loanNumber
				...
				+ ", outstandingAmount=" + outstandingAmount + ", getLoanId()=" + getLoanId() + ", getMobileNumber()="
				+ getMobileNumber() + ", getLoanNumber()=" + getLoanNumber() + ", getLoanType()=" + getLoanType()
				+ ", getTotalLoan()=" + getTotalLoan() + ", getAmountPaid()=" + getAmountPaid()
				+ ", getOutstandingAmount()=" + getOutstandingAmount() + ", getCreatedAt()=" + getCreatedAt()
