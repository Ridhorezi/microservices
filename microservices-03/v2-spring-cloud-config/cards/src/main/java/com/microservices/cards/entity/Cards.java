...
public class Cards extends BaseEntity {
	...
	public String toString() {
		return "Cards [cardId=" + cardId + ", mobileNumber=" + mobileNumber + ", cardNumber=" + cardNumber
				...
				+ ", availableAmount=" + availableAmount + ", getCardId()=" + getCardId() + ", getMobileNumber()="
				+ getMobileNumber() + ", getCardNumber()=" + getCardNumber() + ", getCardType()=" + getCardType()
				+ ", getTotalLimit()=" + getTotalLimit() + ", getAmountUsed()=" + getAmountUsed()
				+ ", getAvailableAmount()=" + getAvailableAmount() + ", getCreatedAt()=" + getCreatedAt()
